...
class TestBot(unittest.TestCase):
    ...
    def test_find_number_strict(self):
        ...
        self.assertEqual(self.bot.find_numbers("7/ !80. !99", True), ["80", "99"])
        self.assertEqual(self.bot.find_numbers("!900 10000", True), ["900"])
        self.assertEqual(self.bot.find_numbers("!Test !1234 5678 !-1", True), ["1234"])
    ...
    def test_find_number_non_strict(self):
        ...
        self.assertEqual(self.bot.find_numbers("7/ !80. !99", False), ["7", "80", "99"])
        self.assertEqual(self.bot.find_numbers("!900 10000", False), ["900", "10000"])
